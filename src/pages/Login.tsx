    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center p-12 w-full h-full">
          ...
          >
            <span className="text-4xl font-bold tracking-tight text-white" style={{ textShadow: '0 0 30px rgba(255,255,255,0.5), 0 0 60px rgba(255,255,255,0.3), 0 0 90px rgba(255,255,255,0.2)' }}>Verifyr</span>
          </motion.div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        ...
        >
          ...
          <div className="lg:hidden mb-10">
            <span className="text-3xl font-bold tracking-tight text-primary" style={{ textShadow: '0 0 20px hsl(var(--primary) / 0.5), 0 0 40px hsl(var(--primary) / 0.3)' }}>Verifyr</span>
          </div>
